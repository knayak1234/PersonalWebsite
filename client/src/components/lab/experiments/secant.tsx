            ...
            <OutputBlock title="Visualization — curve, first secant & root">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ComposedChart data={result.curve} margin={{ top: 10, right: 20, bottom: 20, left: 0 }}>
                  ...
                  <Line type="monotone" dataKey="y" name="f(x)" stroke="#fb923c" strokeWidth={2} dot={false} isAnimationActive animationDuration={900} animationEasing="ease-out" />
                  <Line type="linear" dataKey="s" name="secant through x₀,x₁" stroke="#22d3ee" strokeWidth={1.5} strokeDasharray="6 4" dot={false} connectNulls isAnimationActive animationDuration={900} animationEasing="ease-out" />
